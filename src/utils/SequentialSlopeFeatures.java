...
public class SequentialSlopeFeatures {
    ...
    public void calculateSlopes() {
        ...
        if (selectedCount >= 2) {
            calculateSlopesForSelected(numericColumns, selected);
    ...
    private void showColumnSelectionDialog(List<Integer> numericColumns, List<String> columnNames, boolean[] selected) {
        JDialog dialog = new JDialog(csvViewer, "Select Columns for Slopes", true);
    ...
    private void calculateSlopesForSelected(List<Integer> columns, boolean[] selected) {
        ...
        // Calculate slopes for selected columns
